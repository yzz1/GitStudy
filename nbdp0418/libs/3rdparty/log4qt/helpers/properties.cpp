...
namespace Log4Qt
{
                                   ...
                                   int line)
    {
        ...
        Q_ASSERT_X(value_escape_codes.length() == value_escape_chars.length(), "parseProperty()",
                   "Value escape sequence character definition does not map");
        ...
        Q_ASSERT_X(key_escape_codes.length() == key_escape_chars.length(), "parseProperty()",
                   "Key escape sequence character definition does not map");
