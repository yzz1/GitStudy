...
#include "../../libs/3rdparty/log4qt/logger.h"
...
const QMetaObjectExtraData Log4Qt::Logger::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Log4Qt::Logger::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Log4Qt__Logger,
      qt_meta_data_Log4Qt__Logger, &staticMetaObjectExtraData }
};
