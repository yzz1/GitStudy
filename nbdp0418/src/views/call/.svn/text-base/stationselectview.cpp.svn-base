#include "stationselectview.h"
#include "ui_stationselectview.h"
...
/****************************************************************************
**
** 函数名称：StationSelectView::StationSelectView
** 功能概述: 初始化
** 参数说明
** 作成日期：20151113
** 作成者：  HSCN
...
**
****************************************************************************/
StationSelectView::StationSelectView(QWidget* parent) :
    QWidget(parent),
    ui(new Ui::StationSelectView)
{
    Logging::get()->info("StationSelectView::StationSelectView");

    // 初始化UI
    ui->setupUi(this);
    ui->tiltewidget->setText(tr("CONTACTS  STATION"));
...
/****************************************************************************
**
** 函数名称：StationSelectView::callButtonClickedSlot
** 功能概述: 主叫选择
** 参数说明
** 作成日期：20151113
** 作成者：  HSCN
...
**
****************************************************************************/
void StationSelectView:: callButtonClickedSlot()
{
    Logging::get()->info("StationSelectView::callButtonClickedSlot");
...
/****************************************************************************
**
** 函数名称：StationSelectView::receiveButtonClickedSlot
** 功能概述: 被叫选择
** 参数说明
** 作成日期：20151113
** 作成者：  HSCN
...
**
****************************************************************************/
void StationSelectView:: receiveButtonClickedSlot()
{
    Logging::get()->info("StationSelectView::receiveButtonClickedSlot");
...
/****************************************************************************
**
** 函数名称：StationSelectView::frontPageSlot
** 功能概述: 打开页面时更新页面数据
...
**
****************************************************************************/
void  StationSelectView::frontPageSlot(QString thisID, QString fowordID, QMap<QString, QString>paraMap)
{
    if (fowordID != STATION_SELECT_VIEW)
    {
        return;
    }

    Logging::get()->info("StationSelectView::frontPageSlot");
...
/****************************************************************************
**
** 函数名称：StationSelectView::eventFilter
...
**
****************************************************************************/
bool StationSelectView::eventFilter(QObject* watched, QEvent* event)
{
    Logging::get()->info("StationSelectView::eventFilter");
...
**
****************************************************************************/
StationSelectView::~StationSelectView()
{
    Logging::get()->info("StationSelectView::~StationSelectView");
    delete ui;
}
/****************************************************************************
**
** 函数名称：StationSelectView::homeClickedSlot
...
**
****************************************************************************/
void StationSelectView:: homeClickedSlot()
{
    Logging::get()->info("StationSelectView::homeClickedSlot");
    QMap <QString, QString> paraMap;
    emit afterPageSignal(STATION_SELECT_VIEW, HOME_VIEW_NAME, paraMap);
}
/****************************************************************************
**
** 函数名称：StationSelectView::okButtonClickedSlot
** 功能概述: 跳转到频率选择界面
** 参数说明：
** 作成日期：20151113
** 作成者：  HSCN
...
**
****************************************************************************/
void StationSelectView:: okButtonClickedSlot()
{
    Logging::get()->info("StationSelectView::okButtonClickedSlot");
    ...
    QString callCode = ui->tableView->model()->index(curRow, 4).data().toString();
    paraMap.insert("uuid", uuid);
    paraMap.insert("name", name);
    paraMap.insert("type", "S");
...
/****************************************************************************
**
** 函数名称：StationSelectView::cancelButtonClickedSlot
** 功能概述: 返回到CALL主界面
** 参数说明：
** 作成日期：20151113
** 作成者：  HSCN
...
**
****************************************************************************/
void StationSelectView:: cancelButtonClickedSlot()
{
    Logging::get()->info("StationSelectView::cancelButtonClickedSlot");
    QMap <QString, QString> paraMap;
    emit afterPageSignal(STATION_SELECT_VIEW, CALL_VIEW_NAME, paraMap);
}
/****************************************************************************
**
** 函数名称：StationSelectView::activatedSlot
** 功能概述: 从数据库获取联系站台列表显示
** 参数说明：
** 作成日期：20151113
** 作成者：  HSCN
...
**
****************************************************************************/
void StationSelectView::activatedSlot(QModelIndex index)
{
    Logging::get()->info("StationSelectView::activatedSlot");
    QMap <QString, QString> paraMap;
    ...
    paraMap.insert("uuid", uuid);
    paraMap.insert("name", name);
    paraMap.insert("type", COMMON_OWER_STATION);
    paraMap.insert("callCode", callCode);
    QString flag;
