    ...
    : QWidget(parent)
{
    ...
    QString mmsicode=QString("179311383");
...
QString StatusWidget::get_strSelfMMSI()
{
    return m_mmsiNo->text();
}
// StatusWidget*  StatusWidget::get()
//{
//    if (0 == m_pInstance)
//    {
//        m_pInstance = new  StatusWidget(this);
//    }
