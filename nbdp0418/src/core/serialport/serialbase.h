...
class SerialBase : public QIODevice
{
        Q_OBJECT
    ...
    protected:
        ...
        ulong lastErr;
        SerialBase::QueryMode _queryMode;
    ...
    public:
         ...
         * 	\return query mode.
         */
        inline SerialBase::QueryMode queryMode() const { return _queryMode; };
