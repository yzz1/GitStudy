...
**
** Created: Wed May 4 11:51:48 2016
...
static const char qt_meta_stringdata_StatusWidget[] = {
    "StatusWidget\0\0timer_deal_slot_function()\0"
    "mmsi\0SlotSetMMSI(QString)\0state\0"
    "SlotState(QString)\0bResult\0"
    "updateMailIcon(bool)\0"
};
...
void StatusWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->timer_deal_slot_function(); break;
        case 1: _t->SlotSetMMSI((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->SlotState((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 3: _t->updateMailIcon((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
