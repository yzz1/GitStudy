/********************************************************************************
** Form generated from reading UI file 'managerphrasebook.ui'
**
...
#ifndef UI_MANAGERPHRASEBOOK_H
#define UI_MANAGERPHRASEBOOK_H
...
public:
    ...
    void setupUi(QWidget *ManagerPhrasebook)
    {
        if (ManagerPhrasebook->objectName().isEmpty())
            ManagerPhrasebook->setObjectName(QString::fromUtf8("ManagerPhrasebook"));
        ManagerPhrasebook->resize(800, 544);
        ManagerPhrasebook->setStyleSheet(QString::fromUtf8(""));
        editBnt = new QPushButton(ManagerPhrasebook);
...
""));
        ...
        deleteBnt = new QPushButton(ManagerPhrasebook);
...
""));
        ...
        optionBnt = new QPushButton(ManagerPhrasebook);
...
""));
        ...
        nameLabel = new QLabel(ManagerPhrasebook);
...
"color: rgb(183, 183, 183);"));
        ...
        datetimeLabel = new QLabel(ManagerPhrasebook);
...
"color: rgb(183, 183, 183); "));
        ...
        Contactsline = new QFrame(ManagerPhrasebook);
        ...
        arrowUpButton = new QPushButton(ManagerPhrasebook);
...
"selection-background-color: url(:/images/Arrow_up_white);"));
        arrowDownButton = new QPushButton(ManagerPhrasebook);
...
""));
        ...
        exportBnt = new QPushButton(ManagerPhrasebook);
...
"	background-color: rgb(16, 34, 56);\n"
"}"));
        importBnt = new QPushButton(ManagerPhrasebook);
...
"}"));
        ...
        controlWidget = new QWidget(ManagerPhrasebook);
...
""));
        ...
        phrasebookTBnt->setEnabled(false);
...
""));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/images/manager_PhraseBook_Btn_SelYes"), QSize(), QIcon::Normal, QIcon::On);
        icon2.addFile(QString::fromUtf8(":/images/manager_PhraseBook_Btn_SelYes"), QSize(), QIcon::Disabled, QIcon::On);
...
""));
        ...
        fileTBnt->setFocusPolicy(Qt::NoFocus);
...
""));
        ...
        newBnt = new QPushButton(ManagerPhrasebook);
...
""));
        ...
        retranslateUi(ManagerPhrasebook);

        QMetaObject::connectSlotsByName(ManagerPhrasebook);
    } // setupUi

    void retranslateUi(QWidget *ManagerPhrasebook)
    {
        ManagerPhrasebook->setWindowTitle(QApplication::translate("ManagerPhrasebook", "Form", 0, QApplication::UnicodeUTF8));
        editBnt->setText(QApplication::translate("ManagerPhrasebook", "&Edit", 0, QApplication::UnicodeUTF8));
        deleteBnt->setText(QApplication::translate("ManagerPhrasebook", "&Delete", 0, QApplication::UnicodeUTF8));
        optionBnt->setText(QApplication::translate("ManagerPhrasebook", "Op&tion", 0, QApplication::UnicodeUTF8));
        nameLabel->setText(QApplication::translate("ManagerPhrasebook", "Number", 0, QApplication::UnicodeUTF8));
        datetimeLabel->setText(QApplication::translate("ManagerPhrasebook", "Phrase", 0, QApplication::UnicodeUTF8));
        arrowUpButton->setText(QString());
        arrowDownButton->setText(QString());
        exportBnt->setText(QApplication::translate("ManagerPhrasebook", " E&xport", 0, QApplication::UnicodeUTF8));
        importBnt->setText(QApplication::translate("ManagerPhrasebook", " I&mport", 0, QApplication::UnicodeUTF8));
        homeTBnt->setText(QApplication::translate("ManagerPhrasebook", "&Home", 0, QApplication::UnicodeUTF8));
        phrasebookTBnt->setText(QApplication::translate("ManagerPhrasebook", "Phrasebook", 0, QApplication::UnicodeUTF8));
        macroTBnt->setText(QApplication::translate("ManagerPhrasebook", "&Macro", 0, QApplication::UnicodeUTF8));
        fileTBnt->setText(QApplication::translate("ManagerPhrasebook", "&File", 0, QApplication::UnicodeUTF8));
        newBnt->setText(QApplication::translate("ManagerPhrasebook", "Ne&w", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class ManagerPhrasebook: public Ui_ManagerPhrasebook {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_MANAGERPHRASEBOOK_H
