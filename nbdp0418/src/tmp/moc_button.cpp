...
**
** Created: Wed May 4 11:51:50 2016
...
static const char qt_meta_stringdata_Button[] = {
    "Button\0\0buttonClicked()\0QString\0"
    "iconName\0"
};
...
int Button::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = iconName(); break;
        }
        _id -= 1;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setIconName(*reinterpret_cast< QString*>(_v)); break;
        }
        _id -= 1;
