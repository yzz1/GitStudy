...
static const char qt_meta_stringdata_SQLiteHelper[] = {
    "SQLiteHelper\0"
};
...
const QMetaObjectExtraData SQLiteHelper::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SQLiteHelper::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SQLiteHelper,
      qt_meta_data_SQLiteHelper, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SQLiteHelper::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SQLiteHelper))
