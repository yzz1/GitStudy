#include "contactsinput.h"
#include "ui_contactsinput.h"
#include <QEvent>
#include <QKeyEvent>
#include <QDebug>
/****************************************************************************
**
** 函数名称：ContactsInput::ContactsInput
** 功能概述: 初始化
** 参数说明： 
** 作成日期：20151113
** 作成者：  HSCN
...
**
****************************************************************************/
ContactsInput::ContactsInput(QWidget* parent) :
    QWidget(parent),
    ui(new Ui::ContactsInput)
{
    ui->setupUi(this);
...
/****************************************************************************
**
** 函数名称：ContactsInput::openEditmode
** 功能概述: 开启编辑模式
** 参数说明： tx或者是rx频率标记
** 作成日期：20151113
** 作成者：  HSCN
...
**
****************************************************************************/
void ContactsInput::openEditmode(bool txOrRx)
{
    m_txOrRx = txOrRx;
    m_editMode = true;
...
/****************************************************************************
**
** 函数名称：ContactsInput::offEditmode
** 功能概述: 关闭编辑模式
** 参数说明： 是否保存标记
** 作成日期：20151113
** 作成者：  HSCN
...
**
****************************************************************************/
void ContactsInput::offEditmode(bool save)
{
    m_editMode = false;
...
/****************************************************************************
**
** 函数名称：ContactsInput::editDataClean
** 功能概述: 清除数据
** 参数说明： 
** 作成日期：20151113
** 作成者：  HSCN
...
**
****************************************************************************/
void ContactsInput::editDataClean()
{
...
**
****************************************************************************/
void ContactsInput::setData(QString str)
{
    ui->pushButton->setText(str);
}
/****************************************************************************
**
** 函数名称：ContactsInput::getData
** 功能概述: 获取字符串
** 参数说明： 
** 作成日期：20151113
** 作成者：  HSCN
...
/****************************************************************************
**
** 函数名称：ContactsInput::widgetSetFocus
** 功能概述: 高亮控件
** 参数说明： 
** 作成日期：20151113
** 作成者：  HSCN
...
**
****************************************************************************/
void  ContactsInput::widgetSetFocus()
{
...
/****************************************************************************
**
** 函数名称：ContactsInput::widgetCleanFocus
** 功能概述: 不高亮控件
** 参数说明： 
** 作成日期：20151113
** 作成者：  HSCN
...
**
****************************************************************************/
void  ContactsInput::widgetCleanFocus()
{
    ui->pushButton->setStyleSheet(QString(" border: none;font-size: 16pt;color: rgb(105, 115, 119);"));
...
/****************************************************************************
**
** 函数名称：ContactsInput::eventFilter
...
**
****************************************************************************/
bool ContactsInput::eventFilter(QObject* watched, QEvent* event)
{
    QStringList lineList;
    lineList << "lineEdit" << "lineEdit_2" << "lineEdit_3" << "lineEdit_4" << "lineEdit_5" << "lineEdit_7" << "lineEdit_8";
