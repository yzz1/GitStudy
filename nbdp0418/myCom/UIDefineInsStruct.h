#ifndef UIDEFINEINSSTRUCT_H
#define UIDEFINEINSSTRUCT_H

//#include "UIDefineDSCMessage.h"
...
//NBDP呼叫指令代码-201
#define INS_CODE_NBDPMessage 0xC9

/*************************************
***********NBDP指令代码***************
**************************************/
#define INS_CODE_NBDP_Turn 0xC9
...
#define INS_CODE_NBDP_TransmitTest 0xCE
#define INS_CODE_NBDP_FollowCommunicate 0xCF
#define INS_CODE_NBDP_Message 0xD0
#define INS_CODE_NBDP_connRadio 0xD1
#define INS_CODE_NBDP_FECStartLink 0xD2
#define INS_CODE_NBDP_CalledReceive 0xD3
#define INS_CODE_NBDP_ReceiveIdle 0xD4
#define INS_CODE_NBDP_StateFlag  0xD6
#define INS_CODE_NBDP_DeviceInfo  0xD7


/******************NBDP 状态******************/
#define STATUS_CODE_NBDP_JIANFAIL 0x00
#define STATUS_CODE_NBDP_JIANSUCC 0x01
#define STATUS_CODE_NBDP_ENLOCK 0x02
#define STATUS_CODE_NBDP_NULOCK 0x03
#define STATUS_CODE_NBDP_COMMEND 0x04
...
#define INS_NBDP_MODE_SCAN 0x04
...
struct type_connectRadioInstruction:public type_BaseInstruction
{
...
struct type_SelfCheckingInstruction:public type_BaseInstruction
{
    union
    {
        struct
        {
            ...
            unsigned char   s_RearSelectorModule:1;
            unsigned char   s_PowerAmpModule:1;
            unsigned char   s_CoreModule:1;
            unsigned char   s_PowerModule:1;
        } SelfChecking1;
    };
    union
    {
...
struct type_SelfCheckingResultInstruction:public type_BaseInstruction
{
    union
    {
        struct
        {
            ...
            unsigned char   s_Reserve3:1;
            unsigned char   s_Reserve4:1;
            //            unsigned char   s_VoltageIn:1;
            //            unsigned char   s_CommunicationLine:1;
            //            unsigned char   s_RFOut:1;
            //            unsigned char   s_StimulateOut:1;
            //            unsigned char   s_PowOut:1;
            unsigned char   s_RearSelectorModule:1;
            unsigned char   s_PowerAmpModule:1;
            unsigned char   s_CoreModule:1;
            unsigned char   s_PowerModule:1;
...
struct type_NBDPMessageInstruction:public type_BaseInstruction
{

    unsigned int  s_DataType;
...
struct type_NBDP_ScanInstruction:public type_BaseInstruction
{
    ...
    unsigned char  s_ScanStatus;//开始或停止请求

    unsigned short int s_VerifyValue;
};
struct type_NBDP_CalledReceiveInstruction:public type_BaseInstruction
{
    unsigned char s_MODE;
    unsigned int  s_TX;
    unsigned int  s_RX;
...
//    unsigned int  s_RX;
    ...
    unsigned char  s_ScanResult;//扫描结果：有无信号
    unsigned short int s_VerifyValue;
};
...
struct type_NBDP_FECStartLinkInstruction:public type_BaseInstruction
{
    unsigned char linkState;
    unsigned short int s_VerifyValue;
};

struct type_NBDP_TransmitTestInstruction:public type_BaseInstruction
{
    unsigned int  s_TX;
    unsigned int  s_RX;
...
struct type_NBDP_StateFlag:public type_BaseInstruction
{
//  unsigned char JianLianSuccess;
//  unsigned char LockInputLan;
//  unsigned char commOver;
  unsigned char StateFlag;
  unsigned short int s_VerifyValue;
};
struct type_NBDP_MesgContInstruction
{
   //unsigned char s
};
struct type_NBDP_MessageInstruction:public type_BaseInstruction
{


    unsigned char  s_DataType[1];
    unsigned char  s_DataZhen[120];
...
struct type_NBDP_ReflashDeviceInfo:public type_BaseInstruction
{

    unsigned char  s_DeviceInfo[40];
    unsigned short int s_VerifyValue;
};
